...
# AWS S3 and SQS Configuration retrieved from environment variables
...
if not S3_BUCKET or not re.match(r'^[a-zA-Z0-9.\-_]{1,255}$', S3_BUCKET):
    raise ValueError("Invalid S3 bucket name. Ensure the BUCKET_NAME variable is set correctly.")
...
sqs_client = session.client('sqs', endpoint_url='https://sqs.us-east-1.amazonaws.com')
